 ...
 * 育儿指南
 */
public class YuErZhiNanListActivity extends BaseActivity implements ExpandableListView.OnChildClickListener {

    private static final String TAG = "YuErZhiNanListActivity";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mHelper = new YuErZhiNanHelper(mContext);
    ...
    public boolean onChildClick(ExpandableListView parent, View v, int groupPosition, int childPosition, long id) {
        ...
        intent.putExtra("url", child.contentPath);
